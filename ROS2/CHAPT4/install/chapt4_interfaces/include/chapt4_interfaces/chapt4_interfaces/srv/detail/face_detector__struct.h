...
typedef struct chapt4_interfaces__srv__FaceDetector_Response
{
  int16_t number;
  float use_time;
  rosidl_runtime_c__int16__Sequence top;
  rosidl_runtime_c__int16__Sequence right;
  rosidl_runtime_c__int16__Sequence bottom;
  rosidl_runtime_c__int16__Sequence left;
