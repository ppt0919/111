  ...
  void * untyped_ros_message)
{
  ...
  // Field name: top
  {
    ...
    if (ros_message->top.data) {
      rosidl_runtime_c__int16__Sequence__fini(&ros_message->top);
    }
  ...
  // Field name: right
  {
    ...
    if (ros_message->right.data) {
      rosidl_runtime_c__int16__Sequence__fini(&ros_message->right);
    }
  ...
  // Field name: bottom
  {
    ...
    if (ros_message->bottom.data) {
      rosidl_runtime_c__int16__Sequence__fini(&ros_message->bottom);
    }
  ...
  // Field name: left
  {
    ...
    if (ros_message->left.data) {
      rosidl_runtime_c__int16__Sequence__fini(&ros_message->left);
    }
