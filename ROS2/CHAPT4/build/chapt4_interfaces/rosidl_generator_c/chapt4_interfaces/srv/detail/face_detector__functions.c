...
chapt4_interfaces__srv__FaceDetector_Response__init(chapt4_interfaces__srv__FaceDetector_Response * msg)
{
  ...
  // use_time
  // top
  if (!rosidl_runtime_c__int16__Sequence__init(&msg->top, 0)) {
    chapt4_interfaces__srv__FaceDetector_Response__fini(msg);
    return false;
  }
  // right
  if (!rosidl_runtime_c__int16__Sequence__init(&msg->right, 0)) {
    chapt4_interfaces__srv__FaceDetector_Response__fini(msg);
    return false;
  }
  // bottom
  if (!rosidl_runtime_c__int16__Sequence__init(&msg->bottom, 0)) {
    chapt4_interfaces__srv__FaceDetector_Response__fini(msg);
    return false;
  }
  // left
  if (!rosidl_runtime_c__int16__Sequence__init(&msg->left, 0)) {
    chapt4_interfaces__srv__FaceDetector_Response__fini(msg);
    return false;
  }
  return true;
...
chapt4_interfaces__srv__FaceDetector_Response__fini(chapt4_interfaces__srv__FaceDetector_Response * msg)
{
  ...
  // use_time
  // top
  rosidl_runtime_c__int16__Sequence__fini(&msg->top);
  // right
  rosidl_runtime_c__int16__Sequence__fini(&msg->right);
  // bottom
  rosidl_runtime_c__int16__Sequence__fini(&msg->bottom);
  // left
  rosidl_runtime_c__int16__Sequence__fini(&msg->left);
}
