...
class FaceDetector_Response(metaclass=Metaclass_FaceDetector_Response):
    ...
    _fields_and_field_types = {
        ...
        'use_time': 'float',
        'top': 'sequence<int16>',
        'right': 'sequence<int16>',
        'bottom': 'sequence<int16>',
        'left': 'sequence<int16>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.top = array.array('h', kwargs.get('top', []))
        self.right = array.array('h', kwargs.get('right', []))
        self.bottom = array.array('h', kwargs.get('bottom', []))
        self.left = array.array('h', kwargs.get('left', []))
    ...
    def top(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'h', \
                "The 'top' array.array() must have the type code of 'h'"
            self._top = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'top' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
        self._top = array.array('h', value)
    ...
    def right(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'h', \
                "The 'right' array.array() must have the type code of 'h'"
            self._right = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -32768 and val < 32768 for val in value)), \
                "The 'right' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
        self._right = array.array('h', value)
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -32768 and val < 32768 for val in value)), \
                "The 'bottom' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
    ...
    def left(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'h', \
                "The 'left' array.array() must have the type code of 'h'"
            self._left = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -32768 and val < 32768 for val in value)), \
                "The 'left' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
        self._left = array.array('h', value)
